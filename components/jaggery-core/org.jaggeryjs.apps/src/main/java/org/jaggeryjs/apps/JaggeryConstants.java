...
public class JaggeryConstants {
    ...
    public static final String ENGINE_POOL_MAX_IDLE = "jaggery.engine.pool.max.idle";

    public static final String ENGINE_POOL_MAX_ACTIVE = "jaggery.engine.pool.max.active";
